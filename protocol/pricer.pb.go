...
type SubscribeRequest struct {
	...
	SymbolId []string                `protobuf:"bytes,2,rep,name=symbol_id,json=symbolId,proto3" json:"symbol_id,omitempty"`
}
...
func (x *SubscribeRequest) GetSymbolId() []string {
	if x != nil {
		return x.SymbolId
	}
	return nil
...
type SubscribeResponse struct {
	...
	Update   *timestamp.Timestamp `protobuf:"bytes,4,opt,name=update,proto3" json:"update,omitempty"`
}
...
func (x *SubscribeResponse) GetSymbolId() string {
	if x != nil {
		return x.SymbolId
	}
	return ""
...
func (x *SubscribeResponse) GetUpdate() *timestamp.Timestamp {
	if x != nil {
		return x.Update
	}
	return nil
...
var file_protocol_pricer_proto_rawDesc = []byte{
	...
	0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52,
	...
	0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
